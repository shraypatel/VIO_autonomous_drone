...
CVPY_TYPE(Mesh, viz_Mesh, cv::viz::Mesh, Mesh, NoBase, pyopencv_cv_viz_viz_Mesh_Mesh, ".viz")
CVPY_TYPE(WMesh, viz_WMesh, Ptr<cv::viz::WMesh>, Ptr, NoBase, pyopencv_cv_viz_viz_WMesh_WMesh, ".viz")
CVPY_TYPE(Color, viz_PyColor, cv::viz::PyColor, PyColor, NoBase, pyopencv_cv_viz_viz_PyColor_PyColor, ".viz")
CVPY_TYPE(Affine3d, viz_PyAffine3d, cv::viz::PyAffine3d, PyAffine3d, NoBase, pyopencv_cv_viz_viz_PyAffine3d_PyAffine3d, ".viz")
CVPY_TYPE(WLine, viz_PyWLine, cv::viz::PyWLine, PyWLine, NoBase, pyopencv_cv_viz_viz_PyWLine_PyWLine, ".viz")
CVPY_TYPE(WPlane, viz_PyWPlane, cv::viz::PyWPlane, PyWPlane, NoBase, pyopencv_cv_viz_viz_PyWPlane_PyWPlane, ".viz")
CVPY_TYPE(WSphere, viz_PyWSphere, cv::viz::PyWSphere, PyWSphere, NoBase, pyopencv_cv_viz_viz_PyWSphere_PyWSphere, ".viz")
CVPY_TYPE(WArrow, viz_PyWArrow, cv::viz::PyWArrow, PyWArrow, NoBase, pyopencv_cv_viz_viz_PyWArrow_PyWArrow, ".viz")
CVPY_TYPE(WCube, viz_PyWCube, cv::viz::PyWCube, PyWCube, NoBase, pyopencv_cv_viz_viz_PyWCube_PyWCube, ".viz")
CVPY_TYPE(WCircle, viz_PyWCircle, cv::viz::PyWCircle, PyWCircle, NoBase, pyopencv_cv_viz_viz_PyWCircle_PyWCircle, ".viz")
CVPY_TYPE(WCone, viz_PyWCone, cv::viz::PyWCone, PyWCone, NoBase, pyopencv_cv_viz_viz_PyWCone_PyWCone, ".viz")
CVPY_TYPE(WCylinder, viz_PyWCylinder, cv::viz::PyWCylinder, PyWCylinder, NoBase, pyopencv_cv_viz_viz_PyWCylinder_PyWCylinder, ".viz")
CVPY_TYPE(WCameraPosition, viz_PyWCameraPosition, cv::viz::PyWCameraPosition, PyWCameraPosition, NoBase, pyopencv_cv_viz_viz_PyWCameraPosition_PyWCameraPosition, ".viz")
CVPY_TYPE(WCoordinateSystem, viz_PyWCoordinateSystem, cv::viz::PyWCoordinateSystem, PyWCoordinateSystem, NoBase, pyopencv_cv_viz_viz_PyWCoordinateSystem_PyWCoordinateSystem, ".viz")
CVPY_TYPE(WCloud, viz_PyWCloud, cv::viz::PyWCloud, PyWCloud, NoBase, pyopencv_cv_viz_viz_PyWCloud_PyWCloud, ".viz")
CVPY_TYPE(WPolyLine, viz_PyWPolyLine, cv::viz::PyWPolyLine, PyWPolyLine, NoBase, pyopencv_cv_viz_viz_PyWPolyLine_PyWPolyLine, ".viz")
CVPY_TYPE(WText, viz_PyWText, cv::viz::PyWText, PyWText, NoBase, pyopencv_cv_viz_viz_PyWText_PyWText, ".viz")
CVPY_TYPE(WText3D, viz_PyWText3D, cv::viz::PyWText3D, PyWText3D, NoBase, pyopencv_cv_viz_viz_PyWText3D_PyWText3D, ".viz")
CVPY_TYPE(WImageOverlay, viz_PyWImageOverlay, cv::viz::PyWImageOverlay, PyWImageOverlay, NoBase, pyopencv_cv_viz_viz_PyWImageOverlay_PyWImageOverlay, ".viz")
CVPY_TYPE(WImage3D, viz_PyWImage3D, cv::viz::PyWImage3D, PyWImage3D, NoBase, pyopencv_cv_viz_viz_PyWImage3D_PyWImage3D, ".viz")
CVPY_TYPE(WGrid, viz_PyWGrid, cv::viz::PyWGrid, PyWGrid, NoBase, pyopencv_cv_viz_viz_PyWGrid_PyWGrid, ".viz")
CVPY_TYPE(WTrajectory, viz_PyWTrajectory, cv::viz::PyWTrajectory, PyWTrajectory, NoBase, pyopencv_cv_viz_viz_PyWTrajectory_PyWTrajectory, ".viz")
CVPY_TYPE(WTrajectoryFrustums, viz_PyWTrajectoryFrustums, cv::viz::PyWTrajectoryFrustums, PyWTrajectoryFrustums, NoBase, pyopencv_cv_viz_viz_PyWTrajectoryFrustums_PyWTrajectoryFrustums, ".viz")
CVPY_TYPE(WTrajectorySpheres, viz_PyWTrajectorySpheres, cv::viz::PyWTrajectorySpheres, PyWTrajectorySpheres, NoBase, pyopencv_cv_viz_viz_PyWTrajectorySpheres_PyWTrajectorySpheres, ".viz")
CVPY_TYPE(WPaintedCloud, viz_PyWPaintedCloud, cv::viz::PyWPaintedCloud, PyWPaintedCloud, NoBase, pyopencv_cv_viz_viz_PyWPaintedCloud_PyWPaintedCloud, ".viz")
CVPY_TYPE(WCloudCollection, viz_PyWCloudCollection, cv::viz::PyWCloudCollection, PyWCloudCollection, NoBase, pyopencv_cv_viz_viz_PyWCloudCollection_PyWCloudCollection, ".viz")
CVPY_TYPE(WCloudNormals, viz_PyWCloudNormals, cv::viz::PyWCloudNormals, PyWCloudNormals, NoBase, pyopencv_cv_viz_viz_PyWCloudNormals_PyWCloudNormals, ".viz")
CVPY_TYPE(Viz3d, viz_PyViz3d, Ptr<cv::viz::PyViz3d>, Ptr, NoBase, pyopencv_cv_viz_viz_PyViz3d_PyViz3d, ".viz")
...
CVPY_TYPE(WindowScene, ovis_WindowScene, Ptr<cv::ovis::WindowScene>, Ptr, NoBase, 0, ".ovis")
