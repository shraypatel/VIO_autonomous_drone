...
typedef cv::ovis::EntityProperty ovis_EntityProperty;
CV_PY_FROM_ENUM(ovis_EntityProperty)
CV_PY_TO_ENUM(ovis_EntityProperty)

typedef cv::ovis::MaterialProperty ovis_MaterialProperty;
CV_PY_FROM_ENUM(ovis_MaterialProperty)
CV_PY_TO_ENUM(ovis_MaterialProperty)

typedef cv::ovis::SceneSettings ovis_SceneSettings;
CV_PY_FROM_ENUM(ovis_SceneSettings)
CV_PY_TO_ENUM(ovis_SceneSettings)
